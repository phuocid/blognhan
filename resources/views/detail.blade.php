			...
			<div class="col-md-8">
				...
				<div class="card">
					<h5 class="card-header">
						{{$detail->title}}
						<span class="float-right">Lược xem={{$detail->views}}</span>
					</h5>
				...
				<!-- Fetch Comments -->
				<div class="card my-4">
					<h5 class="card-header">Bình luận <span class="badge badge-dark">{{count($detail->comments)}}</span></h5>
					<div class="card-body">
						@if($detail->comments)
							@foreach($detail->comments as $comment)
								<blockquote class="blockquote">
								  ...
								  <footer class="blockquote-footer">Quản trị viên</footer>
								  @else
