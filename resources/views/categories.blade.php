			...
			<div class="col-md-8">
				<div class="row mb-5"> 
					@if(count($categories)>0)
						...
						<div class="col-md-4">
							<div class="card">
							  <a href="{{url('category/'.Str::slug($category->title).'/'.$category->id)}}"><img height="200" src="{{asset('imgs/'.$category->image)}}" class="card-img-top" alt="{{$category->title}}" /></a>
							  <div class="card-body">
						...
						@endforeach
					@else
					<p class="alert alert-danger">Không tìm thấy danh mục</p>
					@endif
				</div>
				<!-- Pagination -->
				{{$categories->links()}}
