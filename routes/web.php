...
Route::post( "create/account", [HomeController::class, "createAccountPost"] )->name( "createAccountPost" );
Route::get( "emailConfirm/{email}", [HomeController::class, "emailConfim"] )->name( "emailConfim" );
Route::post( "emailConfirm", [HomeController::class, "emailVery"] )->name( "email.confirm" );
